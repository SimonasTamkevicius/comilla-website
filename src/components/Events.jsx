  ...
  return (
    <div className='w-screen h-screen container-content'>
      ...
      <section className='content relative mt-[88px]'>
        <div className='absolute inset-0'>
            {loading && (
                <div className=' absolute inset-0 bg-opacity-50 z-40 flex justify-center items-center pt-10'>
                    <div className="loader-black absolute text-5xl" />
                </div>
            )}
        </div>
        ...
        <div className={`flex flex-col justify-center ${events.length === 0 ? 'items-start' : 'items-center'} items-center mt-10 mb-32 mx-10 md:mx-20 lg:mx-36 space-y-10 z-20`}>
